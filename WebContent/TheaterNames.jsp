...
<nav class="navbar navbar-default" style="background-color: #f54803">
		...
		<div>
		<div>
			<div class="col-sm-4"><img src="<%out.print(rpic.getProfilePic(movie));%>" style="width: 350px; height: 300px"></img></div></div>
			<div>
			<div class="col-sm-8">
...
<div class=well-lg size=70px style="background-color: #313637; margin-top: 400px"> <footer>
